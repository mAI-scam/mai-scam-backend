...
# =============================================================================
# WEBSITE V2 COMPREHENSIVE ANALYSIS (SEA-LION V4)
# =============================================================================

async def analyze_website_comprehensive_v2(
    url: str,
    title: str, 
    content: str,
    target_language: str,
    ...
    """
    Perform comprehensive website analysis with single SEA-LION v4 LLM call.
    
    This function analyzes website content for scam indicators using the upgraded
    SEA-LION v4 model without reasoning toggle functionality.
    
    This function combines language detection, scam analysis, and target language
    output into one efficient Sea-Lion v4 API call, reducing from 3 calls to 1 call.
    ...
    Example:
        result = await analyze_website_comprehensive_v2(
            url="https://fake-bank-login.com",
            title="Secure Bank Login",
            content="Enter your credentials to access...",
            target_language="en",
